...
inline constexpr std::array<RealWeaponSpec, (uint32_t)RealWeaponID::COUNT> REAL_WEAPONS{{
    ...
    { RealWeaponID::M18_CLAYMORE,    7, "M18 Claymore",         "M18A1 Directional Anti-Personnel",95.0f, 1.0f,  1,  6,   0.0f, 40.0f,  0.45f,2},
    { RealWeaponID::M67_GRENADE,     7, "M67 Grenade",          "M67 Fragmentation Grenade",      90.0f, 1.0f,  1,  4,   0.0f, 30.0f,  0.40f,2},
    { RealWeaponID::M15_MINE,        7, "M15 Anti-Tank Mine",   "M15 Mine",                      140.0f, 1.0f,  1,  2,   0.0f, 35.0f,  0.60f,3},
    { RealWeaponID::SEEKER_BOT,      7, "Seeker Bot",           "Semi-tracking robotic explosive",80.0f, 0.8f,  1,  4,   0.0f, 60.0f,  0.35f,2},
    { RealWeaponID::ALIEN_MINE,      7, "Alien Mine",           "Proximity-triggered alien mine",120.0f,1.0f,  1,  4,   0.0f, 25.0f,  0.55f,3},
    { RealWeaponID::SENTRY_BOT,      1, "Sentry Bot",           "Auto-turret deployed by aliens",35.0f, 0.12f, 60,180, 900.0f, 80.0f,  1.2f, 2},
    // Theoretical space weapons
